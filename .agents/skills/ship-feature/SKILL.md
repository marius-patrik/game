...
## 3. Implement
- Respect coding rules in [AGENTS.md](../../../AGENTS.md): strict TS, no `as any`, no dead code, no WHAT-comments.
...
- If you discovered a non-obvious gotcha, append to [.Codex/memory/pitfalls.md](../../memory/pitfalls.md).
