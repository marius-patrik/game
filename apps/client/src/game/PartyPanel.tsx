...
export function PartyPanel({
  ...
  return (
    <div className="pointer-events-none absolute top-2 left-2 z-10 flex flex-col gap-1.5 rounded-xl border border-border/40 bg-background/75 px-2.5 py-2 shadow-md backdrop-blur-md sm:top-4 sm:left-4">
