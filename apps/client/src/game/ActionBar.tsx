  ...
  return (
    <div className="pointer-events-auto absolute bottom-2 left-1/2 z-10 max-w-[calc(100vw-0.5rem)] -translate-x-1/2 px-1 sm:bottom-4 sm:max-w-[calc(100vw-1rem)] sm:px-2">
      <div
        ...
        className="flex items-end gap-1 rounded-2xl border border-border/40 bg-background/75 px-2 py-2 shadow-md backdrop-blur-md sm:gap-1.5 sm:px-3"
      >
        ...
        <Separator orientation="vertical" className="mx-0.5 h-8 self-center sm:h-10" />
