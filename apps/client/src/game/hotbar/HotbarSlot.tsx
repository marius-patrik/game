...
export function HotbarSlot({
  ...
  return (
    <button
      ...
      onDrop={onDrop}
      className={cn(
        "group relative flex size-9 shrink-0 items-center justify-center overflow-hidden rounded-xl border bg-background/85 shadow-md backdrop-blur-md transition-transform sm:size-12",
        distinct && "size-11 sm:size-14",
    ...
    >
      ...
      <div
        className={cn(
          "flex size-5 items-center justify-center rounded-md border text-[10px] font-black leading-none sm:size-6 sm:text-xs",
          distinct && "size-6 sm:size-7",
        )}
        style={{
